			...
			<!-- Main -->
				<article id="main">
					...
					<header class="special container">
						...
						<h2>Aqui puede subir su <strong>noticia</strong></h2>
						<p>Llene los campos de abajo y presione en subir!</p>
					</header>
					...
					<!-- One -->
						<section class="wrapper style4 special container 75%">
							...
							<!-- Content -->
								<div class="content">
									<form action="../funcionalidad/guardar1.php" name="guardar" method="post" onsubmit="return validacion()" id="guardar" enctype="multipart/form-data">
										<div class="row 50%">
											<div class="12u">
												<input type="text" name="titulo" placeholder="Titulo" maxlength="60" />
											</div>
										</div>
										<div class="row 50%">
											<div class="12u">
												<textarea name="cuerpo" placeholder="cuerpo maximo 200 caracteres" rows="7" maxlength="200"></textarea>
											</div>
										</div>
										...
										<div class="row">
											<div class="12u">
												<ul class="buttons">
													<li><input type="submit" class="special" value="Subir noticia" /></li>
												</ul>
											</div>
										</div>
									</form>
