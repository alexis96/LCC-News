...
<html>
	...
	<?php
      ...
      <header id="header" class="al">
			...
			<!-- Main -->
				...
				<article id="main">
					...
					<header class="special container">
						...
						<h2>Eliminar <strong>noticias</strong></h2>
						<p></p>
					</header>
					...
					<div class="wrapper style4 special container 75%">
						...
						<div class="list-group">
							...
							?>
  							<a href="..\funcionalidad\eliminacion.php?id=<?php echo $idNum; ?>" >
		...
		<!-- Scripts -->
			<script>
				document.getElementById("demo").innerHTML = "Mantecas";
			</script>
